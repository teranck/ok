...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/921829eb-6a4d-42ce-b085-c338463bc4e7"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="921829eb-6a4d-42ce-b085-c338463bc4e7"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/97e84d01-6f41-403f-ac10-f515f26d651e"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="97e84d01-6f41-403f-ac10-f515f26d651e"
fi
echo ${Vmess_UUID}
